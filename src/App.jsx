...
import fotoPlaca from './foto_placa.jpg';
...
const unidadesData = [
  {
    ...
    instagram: 'https://www.instagram.com/clsoutletararas?igsh=MXdpNzFhdHJleHd4aw==',
...
function App() {
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 font-sans selection:bg-green-600 selection:text-white relative">
      
      <nav className="fixed top-0 w-full z-50 bg-neutral-950/95 backdrop-blur-md border-b border-green-800 px-6 py-4 flex justify-between items-center shadow-2xl">
        <div className="text-2xl md:text-3xl font-black uppercase tracking-tighter cursor-pointer" onClick={() => window.scrollTo(0,0)}>
          CLS <span className="text-green-600">OUTLET</span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-8 text-xs font-bold tracking-[0.2em] uppercase text-neutral-300">
          ...
          <a 
            href="https://www.instagram.com/clsoutletararas?igsh=MXdpNzFhdHJleHd4aw==" 
            target="_blank" 
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-green-600 text-white px-6 py-3 rounded hover:bg-green-500 transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(22,163,74,0.4)]"
          >
            WHATSAPP
          </a>
        </div>
      ...
      <header className="relative w-full h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden border-b-2 border-green-700 pt-20">
        <div className="absolute inset-0 z-0">
          <img 
            src="/foto_motos.jpg" 
            alt="Motos elétricas em oferta na CLS Outlet" 
        ...
        <div className="z-10 max-w-4xl w-full flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-6">
            ...
            <a 
              href="#unidades" 
              className="px-8 py-4 bg-neutral-800/80 backdrop-blur-sm border-2 border-green-700 text-green-500 font-bold rounded-lg hover:bg-green-700 hover:text-white transition-all duration-300 text-center"
            >
      ...
      <section id="sobre" className="py-24 px-6 md:px-12 bg-neutral-900">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="relative order-2 md:order-1">
            <div className="absolute inset-0 border-2 border-green-700 rounded-lg translate-x-4 translate-y-4 -z-10"></div>
            <img 
              src={fotoPlaca} 
              alt="Placa CLS Outlet Araras" 
              className="w-full rounded-lg shadow-2xl brightness-90 saturate-[1.1]" 
            />
            <div className="absolute -bottom-6 -right-6 bg-green-600 text-white font-black px-6 py-4 rounded-md shadow-[0_10px_30px_rgba(22,163,74,0.5)] rotate-[3deg] scale-105">
          ...
          <div className="flex flex-col gap-6 order-1 md:order-2">
            <p className="text-green-500 uppercase font-semibold tracking-widest text-sm">Quem somos</p>
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter uppercase">
              Uma história de <span className="text-green-600">valor</span> e qualidade
            </h2>
            <div className="w-20 h-1 bg-green-700 mt-2 mb-4"></div>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 text-neutral-200">
              <li className="flex items-start gap-3"><span className="text-green-600">✅</span> Produtos novos e revisados</li>
              <li className="flex items-start gap-3"><span className="text-green-600">🏷️</span> Preços abaixo do varejo</li>
              <li className="flex items-start gap-3"><span className="text-green-600">🔄</span> Estoque rotativo constante</li>
              <li className="flex items-start gap-3"><span className="text-green-600">🚀</span> Vendas online e envio ágil</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section id="categorias" className="py-24 px-6 md:px-12 bg-neutral-950 border-t border-neutral-800">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-green-500 uppercase font-semibold tracking-widest text-sm mb-1">O que você encontra aqui</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {categoriasData.map((cat, index) => (
              <div key={index} className="bg-neutral-900 p-8 rounded-lg border border-neutral-800 hover:border-green-600 transition-all duration-300 group hover:shadow-2xl flex flex-col items-center text-center">
      ...
      <section id="motos-eletricas" className="py-24 px-6 md:px-12 bg-neutral-900 border-t border-green-900">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-16 text-center">
          
          <div className="max-w-3xl">
            <p className="text-green-500 uppercase font-semibold tracking-widest text-sm">Mobilidade Sustentável</p>
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter uppercase mt-2">
              A Revolução das <span className="text-green-600">Motos Elétricas</span>
            </h2>
            <p className="text-neutral-300 mt-6 text-lg leading-relaxed">
              Na CLS Outlet, o futuro já chegou. Apresentamos nossa nova linha de motos elétricas: a união perfeita entre <strong>tecnologia, economia extrema e design arrojado</strong>. Diga adeus aos postos de combustível e à manutenção cara.
            </p>
          </div>

          <div className="w-full max-w-4xl overflow-hidden rounded-xl border-2 border-green-800 shadow-[0_0_40px_rgba(22,163,74,0.2)]">
            <img
              src="/foto_motos.jpg"
              alt="Motos elétricas em oferta na CLS Outlet"
              className="w-full h-full object-cover brightness-90 saturate-[1.1] hover:scale-105 transition-transform duration-500"
            />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full text-left">
            <div className="bg-neutral-950 p-6 rounded-lg border border-neutral-800 border-b-4 border-b-green-600 hover:-translate-y-2 transition-transform duration-300">
          ...
          <div className="w-full max-w-4xl aspect-video bg-neutral-950 rounded-xl border-4 border-neutral-800 shadow-[0_0_40px_rgba(22,163,74,0.15)] overflow-hidden">
            <iframe 
      ...
      <section id="unidades" className="py-24 px-6 md:px-12 bg-neutral-950 border-t border-neutral-800">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          <div className="text-center mb-16">
            <p className="text-green-500 uppercase font-semibold tracking-widest text-sm">Onde estamos</p>
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter uppercase mt-2">
              Nossas <span className="text-green-600">unidades</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
            {unidadesData.map((u, index) => (
              <div key={index} className="bg-neutral-900 p-10 rounded-xl border border-neutral-700 flex flex-col gap-6 group hover:border-green-800 transition-all duration-300 relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1.5 bg-green-700 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
                
                <h3 className="text-2xl font-black text-green-500 uppercase tracking-wider flex items-center gap-3">
                  📍 {u.city}
                </h3>
                ...
                <div className="text-neutral-300 space-y-4 text-sm leading-relaxed">
                  ...
                  <p>
                    ...
                    <a href={u.instagram} target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-400">
                      {u.handle}
                    </a>
                  </p>
                </div>
                ...
                <div className="mt-4 bg-neutral-950 p-6 rounded-md border border-neutral-800 text-sm">
                  ...
                  {horariosData.map(h => (
                    <div key={h.dia} className="flex justify-between py-1.5 border-b border-neutral-800 last:border-0">
                      <span>{h.dia}</span>
                      <span className="text-green-500 font-bold">{h.hora}</span>
                    </div>
                  ))}
                  <p className="text-xs text-green-800 italic mt-3 leading-tight">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="mt-6 w-full px-6 py-3 text-center bg-gradient-to-r from-teal-800 via-green-600 to-yellow-500 text-white font-bold rounded-lg uppercase text-xs tracking-widest hover:opacity-90 transition-all"
                >
                  Seguir no Instagram
                </a>
              </div>
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-[0_4px_20px_rgba(34,197,94,0.5)] hover:bg-green-400 hover:scale-110 transition-all duration-300 flex items-center justify-center"
      ...
      <footer className="py-12 px-6 bg-neutral-900 border-t-2 border-green-700 text-center text-neutral-500 text-sm">
